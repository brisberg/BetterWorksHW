...
describe('Gauge Directive Rendering', function () {
    ...
    it('should render HTML based on scope correctly', function () {
        ...
        expect(element.html().trim()).toEqual(
            ...
            '<text font-size="20px" transform="translate(0,-2)" style="text-anchor: middle;">66%</text>' +
            '<text font-size="12px" font-style="oblique" transform="translate(0,15)" style="text-anchor: middle;">Progress</text>' +
            '</g>' +
            '</svg>');
    });
